...
<div class="member-details-card" id="member-details{{$member->id}}">
  ...
  <form class="member-form" id="member-form{{$member->id}}" action="updateMember" method="POST">
    {{csrf_field()}}
    <input type="hidden" name="id" value="{{$member->id}}">
    <div class="form-group">
      <label for="membership_no">Membership Number: </label>
      <input type="text" name="membership_no" value="{{$member->membership_no}}">
    </div>
    
    <div class="form-group">
      <label for="id_passport_no">ID or Passport: </label>
      <input type="text" name="id_passport_no" value="{{$member->id_passport_no}}">
    </div>

    <div class="form-group">
      <label for="status">Status: </label>
      <input type="text" name="status" value="{{$member->status}}">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" name="initials" value="{{$member->initials}}">
    </div>

    <div class="form-group">
      <label for="f_name">Name: </label>
      <input type="text" name="f_name" value="{{$member->f_name}}">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" name="cell_number" value="{{$member->cell_number}}">
    </div>

    <div class="form-group">
      <label for="tel_number">Tel Number: </label>
      <input type="text" name="tel_number" value="{{$member->tel_number}}">
    </div>

    <div class="form-group">
      <label for="marital_status">Marital Status: </label>
      <input type="text" name="marital_status" value="{{$member->marital_status}}">
    </div>

    <div class="form-group">
      <label for="insolvency">Insolvency: </label>
      <input type="text" name="insolvency" value="{{$member->insolvency}}">
    </div>

    <div class="form-group">
      <label for="liquidation">Liquidation: </label>
      <input type="text" name="liquidation" value="{{$member->liquidation}}">
    </div>
